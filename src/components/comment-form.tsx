...
export function CommentForm({ onCommentPosted }: CommentFormProps) {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    // Show permanence modal if user hasn't acknowledged yet
    if (!getPermanenceAck()) {
      setModalOpen(true);
      return;
    }
      ...
      >
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="Say something. It'll be on-chain forever."
            rows={3}
            disabled={isSubmitting}
        ...
        <p className="text-xs text-neutral-600 text-center">
          Free to post — the app pays BSV miner fees
        </p>
      </form>
    </>
  );
